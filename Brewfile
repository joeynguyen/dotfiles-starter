...
brew "fd" # find entries in the filesystem.
brew "glow" # MarkDown preview CLI util
brew "grep" # GNU grep (aliased to "ggrep"), egrep and fgrep
brew "gnu-sed" # aliased to "gsed"
brew "icdiff" # diff files with syntax highlighting
brew "fzf" # required for ctrl+r shortcut and zoxide
...
brew "oh-my-posh" # customizable and fast prompt theme engine for any shell
...
brew "tlrc" # Replacement for unmaintained tldr package
brew "trash" # Move files/folders to the trash (alternative to rm when you're not sure about deleting permanently)
